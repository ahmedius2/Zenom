...
#include "../../../zenom/zenom/scene/viewerwidget.h"
...
const QMetaObject ViewerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ViewerWidget,
...
void *ViewerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "osgViewer::Viewer"))
        return static_cast< osgViewer::Viewer*>(const_cast< ViewerWidget*>(this));
