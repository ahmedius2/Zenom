...
#include "../../../zenom/zenom/scene/scenemanager.h"
...
static const char qt_meta_stringdata_SceneManager[] = {
    "SceneManager\0\0pText\0warningMessage(QString)\0"
    "SceneWindow*\0createScene()\0pSceneWindow\0"
    "sceneWindowDestroyed(SceneWindow*)\0"
};
...
void SceneManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->warningMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: { SceneWindow* _r = _t->createScene();
            if (_a[0]) *reinterpret_cast< SceneWindow**>(_a[0]) = _r; }  break;
        case 2: _t->sceneWindowDestroyed((*reinterpret_cast< SceneWindow*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void SceneManager::warningMessage(const QString & _t1)
{
